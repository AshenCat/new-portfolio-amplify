        ...
        <div className="page-container">
            ...
            <div className="dflex">
                <div className="left">
                    <img src={me} alt="me" />
                    <div className="icons">
                        <IoLogoLinkedin onClick={()=>openInNewTab('https://www.linkedin.com/in/klifford-agujar-8714a41a9/')} style={{color: '#0A66C2'}} />
                        <IoLogoGithub onClick={()=>openInNewTab('https://github.com/ashencat')} style={{color: '#0A66C2'}} />
                    </div>
                </div>
                <div className="right">
